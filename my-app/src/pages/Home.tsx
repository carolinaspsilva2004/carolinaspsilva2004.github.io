                    ...
                    <div className="modal" onClick={(e) => e.stopPropagation()}>
                        {modal === "cv" && (
                            <>
                                ...
                                <div className="modal-actions">
                                    <a href="/assets/CarolinaSilva_CV.pdf" download className="confirm">Yes, download</a>
                        ...
                        {modal === "github" && (
                            <>
                                ...
                                <div className="modal-actions">
                                    <a href="https://github.com/carolinaspsilva2004" target="_blank" rel="noreferrer" className="confirm">Continue</a>
                                    <button onClick={() => setModal(null)}>Cancel</button>
                                </div>
                            </>
                        )}
                        ...
                        {modal === "linkedin" && (
                            <>
                                ...
                                <div className="modal-actions">
                                    <a href="https://www.linkedin.com/in/carolinaspsilva2004" target="_blank" rel="noreferrer" className="confirm">Continue</a>
                                    <button onClick={() => setModal(null)}>Cancel</button>
                                </div>
                            </>
                        )}
                        ...
                        {modal === "contact" && (
                            <>
                                ...
                                <div className="modal-actions">
                                    <a href="mailto:carolinaspsilva.ua@gmail.com" className="confirm">Open email</a>
                                    <button onClick={() => setModal(null)}>Cancel</button>
                                </div>
                            </>
                        )}
